<template>
  <ul class="nav flex-column">
    ...
    <li class="nav-item mt-2">
      ...
      <router-link to="/menu01/exam03view" class="nav-link text-warning">중첩된 라우트 뷰</router-link>
      <router-link to="/menu01/exam04view" class="nav-link text-warning">이름이 있는 라우트 뷰</router-link>
    ...
    <li class="nav-item mt-2">
      ...
      <router-link to="/menu02/exam01expressions" class="nav-link text-warning">표현식 데이터 바인딩</router-link>
      <router-link to="/menu02/exam02directives" class="nav-link text-warning">디렉티브 데이터 바인딩</router-link>
    ...
    <li class="nav-item">
      ...
      <router-link to="/menu04/exam03inject" class="nav-link text-warning">의존 데이터 삽입(ingect 이용)</router-link>
    ...
    <li class="nav-item">
      <h6 class="text-white">Menu07: Axios sAJAX</h6>
